<header class="sticky top-0 z-50 bg-white border-b border-gray-200 h-16 px-4 lg:px-7 flex items-center gap-4 w-full">
    
    {{-- Tombol Hamburger Mobile --}}
    <button class="lg:hidden text-xl text-gray-500 hover:text-gray-700 transition-colors shrink-0" onclick="toggleSidebar()">
        <i class="fa-solid fa-bars"></i>
    </button>

    {{-- Search Bar: Ditambahkan max-w-lg agar tidak terlalu lebar di desktop --}}
    ...
    {{-- Topbar Actions: Ditambahkan shrink-0 agar tidak ikut tertekan --}}
