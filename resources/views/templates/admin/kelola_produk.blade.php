...
<script>
    // ==================== KONFIGURASI ====================
    const API_BASE = '/api/barang';
    const KATEGORI_API = '/api/kategori';
    ...
    async function loadKategori() {
        try {
            const res = await fetch(KATEGORI_API);
    ...
    async function submitProduk(e) {
        ...
        formData.append('diskon_persen', document.getElementById('diskon_persen').value || '');
        ...
        try {
            ...
            if (!res.ok || !json.success) {
                alert(json.message || 'Gagal menyimpan produk. Cek kembali data yang diisi.');
                return;
            }
