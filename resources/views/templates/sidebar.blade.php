<aside id="sidebar" class="w-[220px] bg-white flex flex-col py-6 px-4 fixed inset-y-0 left-0 border-r border-gray-200 z-[100] transition-transform duration-300 transform -translate-x-full lg:translate-x-0">
    ...
    @php $role = session('user.role', 'customer'); @endphp
    ...
    @elseif($role === 'staff')
        ...
        {{-- 2. MENU KHUSUS STAFF          --}}
        {{-- ============================== --}}
        <div class="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-2 mb-2">Dashboard Staff</div>

        <a href="{{ route('staff.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm mb-0.5 transition-colors {{ request()->routeIs('staff.dashboard') ? 'bg-[#2D7A42] text-white font-semibold shadow-sm' : 'text-gray-500 font-medium hover:bg-[#E8F5EC] hover:text-[#2D7A42]' }}">
            <i class="fa-solid fa-list-check w-[18px] text-center text-[15px]"></i> Kelola Pesanan
        </a>
    ...
    @elseif($role === 'manager')
        {{-- ============================== --}}
        {{-- 3. MENU KHUSUS MANAGER        --}}
        {{-- ============================== --}}
        <div class="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-2 mb-2">Dashboard Manager</div>

        <a href="{{ route('manager.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm mb-0.5 transition-colors {{ request()->routeIs('manager.dashboard') ? 'bg-[#2D7A42] text-white font-semibold shadow-sm' : 'text-gray-500 font-medium hover:bg-[#E8F5EC] hover:text-[#2D7A42]' }}">
            <i class="fa-solid fa-chart-line w-[18px] text-center text-[15px]"></i> Laporan & Analitik
        </a>
    ...
    @elseif($role === 'supplier')
        {{-- ============================== --}}
        {{-- 4. MENU KHUSUS SUPPLIER       --}}
        {{-- ============================== --}}
        <div class="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-2 mb-2">Dashboard Supplier</div>
