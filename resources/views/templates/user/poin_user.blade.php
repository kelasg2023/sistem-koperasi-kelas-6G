        ...
        <div class="relative z-10 w-full md:w-auto text-left">
            <div class="flex items-center gap-2 mb-2">
                ...
                <span class="bg-white/20 backdrop-blur-md px-2 py-0.5 rounded text-[10px] font-bold">
                    <i class="fa-solid fa-crown mr-1 text-[#FFD700]"></i>Member Gold
                </span>
            </div>
            <h2 class="text-4xl lg:text-5xl font-extrabold mb-1 tracking-tight">840 <span class="text-2xl font-bold opacity-80">Pts</span></h2>
            <p class="text-sm text-white/90 font-medium mt-2">
                <i class="fa-solid fa-equals text-xs opacity-70 mr-1"></i> Nilai tukar: Rp 8.400
            </p>
        </div>
            ...
            <div class="space-y-1">
                ...
                <div class="flex items-center gap-4 p-3 -mx-3 rounded-xl hover:bg-gray-50 transition-colors border-b border-gray-50 last:border-0 group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">Transaksi INV-050726-001</p>
                    </div>
                    <div class="text-right">
                        <span class="text-sm font-extrabold text-[#F5820A]">+ 45 Pts</span>
                        <p class="text-[10px] font-medium text-gray-400 mt-1">05 Jul 2026</p>
                    </div>
                </div>

                {{-- Riwayat 2 (Dapat Poin) --}}
                <div class="flex items-center gap-4 p-3 -mx-3 rounded-xl hover:bg-gray-50 transition-colors border-b border-gray-50 last:border-0 group">
                    <div class="w-10 h-10 rounded-full bg-[#FFF3E0] text-[#F5820A] flex items-center justify-center shrink-0 group-hover:bg-[#FFE0B2] transition-colors">
                        <i class="fa-solid fa-plus"></i>
                    </div>
                    <div class="flex-1">
                        <h4 class="text-sm font-bold text-gray-800">Bonus Setor Simpanan Wajib</h4>
                        <p class="text-xs text-gray-500 mt-0.5">Bulan Juli 2026</p>
                    </div>
                    <div class="text-right">
                        <span class="text-sm font-extrabold text-[#F5820A]">+ 50 Pts</span>
                        <p class="text-[10px] font-medium text-gray-400 mt-1">01 Jul 2026</p>
                    </div>
                </div>
                
                {{-- Riwayat 3 (Tukar Poin / Berkurang) --}}
                <div class="flex items-center gap-4 p-3 -mx-3 rounded-xl hover:bg-gray-50 transition-colors border-b border-gray-50 last:border-0 group">
                    <div class="w-10 h-10 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center shrink-0 group-hover:bg-gray-200 transition-colors">
