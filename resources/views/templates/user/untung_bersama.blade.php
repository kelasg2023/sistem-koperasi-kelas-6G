...
@section('content')
<div class="w-full px-4 lg:px-8 py-8" x-data="untungPage()">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm flex flex-col justify-center">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <h2 class="text-2xl font-extrabold text-gray-900"><span x-text="poin"></span> Poin</h2>
                    </div>
                </div>
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex items-start gap-4 py-4 border-b border-gray-50 last:border-0">
                        ...
                        <div class="flex-1 pt-1">
                            <h4 class="text-sm font-bold text-gray-800">Pembagian SHU Tahun Lalu</h4>
    ...
    <div x-show="!isLoading && !isMember" class="text-center py-20 bg-white rounded-2xl shadow-sm border border-gray-100" x-cloak>
        ...
        <p class="text-gray-500 mb-6 text-sm">Anda harus terdaftar sebagai member Koperasi 6G untuk menggunakan fitur Bagi Hasil & Untung Bersama.</p>
        ...
        async fetchProfile() {
            try {
                ...
                if (json.success && json.data) {
                    ...
                    if (json.data.user && json.data.user.customer) {
                        this.poin = json.data.user.customer.point || 0;
                    }
                }
            } catch (e) {
