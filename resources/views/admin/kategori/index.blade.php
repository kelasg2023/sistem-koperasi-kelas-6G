...
<script>
                ...
                <tr class="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td class="p-4 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="/admin/kategori/edit/${item.id_kategori}" class="w-8 h-8 rounded-lg bg-amber-50 text-amber-500 flex items-center justify-center hover:bg-amber-500 hover:text-white transition-colors">
    ...
    async function deleteKategori(id) {
        ...
        try {
            const res = await fetch(`${KATEGORI_API}/${id}`, {
                method: 'DELETE',
                headers: {
